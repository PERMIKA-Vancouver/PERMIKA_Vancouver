    ...
    >
      ...
      >
        <div className="flex justify-end">
          <img
            src={isTabletPotraitView ? "https://permika.s3.us-west-2.amazonaws.com/assets/welcome/core.png" : "https://permika.s3.us-west-2.amazonaws.com/assets/welcome/core_square.png"}
            alt="Core Team"
            className={`${
              isTabletPotraitView
